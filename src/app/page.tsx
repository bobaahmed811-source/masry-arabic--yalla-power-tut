  ...
  useEffect(() => {
    ...
    const lang: Record<string, Record<string, string>> = {
      ...
      es: {
        ...
        challenges_title: "Tus Próximos Desafíos", current_challenge_title: "Historia Ilustrada: En el Mercado", current_challenge_desc: "Práctica de diálogos de compra y venta.",
        start_button_text: "Empezar Siguiente Desafío", progress_title: "Progreso de Nivel", level_progress_text: "Restante para Escriba del Papiro",
        leaderboard_title: "Clasificación de Faraones",
        completed_label: "Completado", locked_label: "Bloqueado",
        user_id_label: "ID de Usuario:",
        leaderboard_1: "Reina Hatshepsut", leaderboard_2: "Amenhotep el Sabio", leaderboard_4: "Nefertiti la Graciosa",
        comic_studio_button: "Estudio de Cómics",
        museum_button: "Museo Virtual",
        store_button: "Tienda de Papiros",
        tutor_button: "Tutor de IA",
        word_scramble_button: "Reto de Palabras",
        dialogue_challenge_button: "Reto de Diálogo",
        placement_test_button: "Iniciar Prueba de Nivel",
      ...
      it: {
        ...
        challenges_title: "Le Tue Prossime Sfide", current_challenge_title: "Storia Illustrata: Al Mercato", current_challenge_desc: "Pratica di dialoghi di acquisto e vendita.",
        start_button_text: "Inizia la Prossima Sfida", progress_title: "Avanzamento di Livello", level_progress_text: "Rimanente per Scriba del Papiro",
        ...
        museum_button: "Museo Virtuale",
        store_button: "Negozio di Papiri",
        tutor_button: "Tutor IA",
        word_scramble_button: "Sfida di Parole",
        dialogue_challenge_button: "Sfida di Dialogo",
        placement_test_button: "Inizia Test di Livellamento",
      ...
      nl: {
        ...
        challenges_title: "Je Komende Uitdagingen", current_challenge_title: "Geïllustreerd Verhaal: Op de Markt", current_challenge_desc: "Dialoogoefening voor kopen en verkopen.",
        start_button_text: "Start Volgende Uitdaging", progress_title: "Niveauvoortgang", level_progress_text: "Resterend voor Schrijver van de Papyrus",
        leaderboard_title: "Klassement van de Farao's",
        completed_label: "Voltooid", locked_label: "Vergrendeld",
        user_id_label: "Gebruikers-ID:",
        leaderboard_1: "Koningin Hatsjepsoet", leaderboard_2: "Amenhotep de Wijze", leaderboard_4: "Nefertiti de Gracieuze",
        comic_studio_button: "Stripstudio",
        museum_button: "Virtueel Museum",
        store_button: "Papyri Winkel",
        tutor_button: "AI Tutor",
        word_scramble_button: "Woordenhussel",
        dialogue_challenge_button: "Dialooguitdaging",
        placement_test_button: "Start Niveautest",
      ...
      de: {
        ...
        challenges_title: "Deine Nächsten Herausforderungen", current_challenge_title: "Illustrierte Geschichte: Auf dem Markt", current_challenge_desc: "Dialogübung zum Kaufen und Verkaufen.",
        start_button_text: "Nächste Herausforderung starten", progress_title: "Level-Fortschritt", level_progress_text: "Verbleibend für Schreiber des Papyrus",
        ...
        comic_studio_button: "Comic-Studio",
        museum_button: "Virtuelles Museum",
        store_button: "Papyri-Laden",
        tutor_button: "KI-Tutor",
        word_scramble_button: "Worträtsel",
        dialogue_challenge_button: "Dialog-Herausforderung",
        placement_test_button: "Einstufungstest starten",
