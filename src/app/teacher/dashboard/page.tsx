...
const TEACHER_PROFILE_INITIAL = {
  name: 'الملكة حتشبسوت',
  character: '👑',
  subject: 'فن الحكم والعمارة الملكية',
  status: 'نشطة',
  pricePerHour: 500,
  description: 'أنا حتشبسوت، ملكة مصر القوية. سأعلمكم أسرار القيادة، فنون العمارة التي تحدت الزمن، وحكمة الفراعنة التي بنت أعظم حضارة عرفها التاريخ.',
  averageRating: 5.0,
  totalReviews: 150,
};

const UPCOMING_LESSONS = [
  { id: 201, date: '2025-12-05', time: '10:00 صباحاً', student: 'تحتمس الصغير', subject: 'مبادئ الحكم الفرعوني' },
  { id: 202, date: '2025-12-05', time: '02:00 مساءً', student: 'نفرتيتي المستقبل', subject: 'أسرار بناء معبد الدير البحري' },
  { id: 203, date: '2025-12-06', time: '09:30 صباحاً', student: 'سيت الصغير', subject: 'درس في فنون الخطابة الملكية' },
];
...
const MOCK_REVIEWS = [
  { id: 1, student: 'ملك الصغير', rating: 5, comment: 'جلالة الملكة حتشبسوت ملهمة وقوية! ابني الآن يحلم بأن يكون مهندساً عظيماً.', date: '2025-11-20' },
  { id: 2, student: 'توتو المبهج', rating: 5, comment: 'أفضل درس في التاريخ على الإطلاق. شكراً جزيلاً لجلالتك.', date: '2025-11-18' },
